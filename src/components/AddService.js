...
import image from '../assets/addservice.gif'
...
const AddService = () => {
  ...
  return (
    <section className="md:my-20">
      ...
      <div data-aos="fade-left" className="px-6 h-full text-gray-800">
        <div className="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
          <div>
            <iframe src="https://embed.lottiefiles.com/animation/106544" className="h-96 w-96"></iframe>
          </div>
