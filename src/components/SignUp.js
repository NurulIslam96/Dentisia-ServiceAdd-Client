        ...
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
          ...
          <form onSubmit={handleCreateUser}>
            ...
            <div className="mt-4">
              ...
              <input
                className="block w-full px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 mb-4 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300"
                type="password"
