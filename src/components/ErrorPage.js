            ...
            <div className="flex items-center justify-center  py-12">
                <div className="bg-white border rounded-md flex items-center justify-center mx-4 md:w-2/3 ">
                    <div className="flex flex-col items-center py-16 ">
                        ...
                        <Link className="mx-4 h-10 w-44 border rounded-md text-white text-lg font-semibold flex justify-center items-center bg-indigo-700 hover:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-opacity-50 focus:ring-indigo-800" to={'/'}>Go Back</Link>
                    </div>
                </div>
            </div>
        </div>
