  ...
  return (
    <div>
      ...
      >
        <img
          src={bannerfront}
          className="md:w-96 w-80 place-self-end absolute md:block hidden"
          alt=""
        />
        <div className="flex items-center justify-center w-full h-full bg-gray-900 bg-opacity-50">
          <div className="text-center z-20">
            ...
            <div className="mt-5">
              <Link
                to={"/signup"}
                className="w-full px-4 py-2 text-xl font-semibold text-white uppercase transition-colors duration-300 transform bg-blue-600 rounded-md lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500"
              >
                Get Started
              </Link>
            </div>
      ...
      <section className="p-6 my-6">
        <div
          data-aos="fade-right"
          className="container grid grid-cols-1 gap-6 mx-auto md:mt-36 sm:grid-cols-2 xl:grid-cols-4"
        >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://www.afamilydentalcarecenter.com/wp-content/uploads/2019/02/DentalOfficeBackground.png')",
